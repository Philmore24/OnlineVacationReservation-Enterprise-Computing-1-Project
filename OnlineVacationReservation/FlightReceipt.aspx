            ...
            <tbody>
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%" style="border: 1px solid #ccc; margin: 0 0 25px;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="font-weight: 400; background-color: #5191fa; color: #fff; padding: 10px 15px; border-left: 1px solid #fff; width: 25%;">Booking Status
                                    </th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="font-size: 17px; padding: 15px; text-align: center; border-left: 1px solid #ccc;">
                                        <asp:Label ID="BookStatus" runat="server"></asp:Label>
                                    </td>
                                    <td style="font-size: 17px; padding: 15px; text-align: center; border-left: 1px solid #ccc;">
                ...
                <tr>
                    <td style="border: 1px solid #ccc; border-top-width: 2px" colspan="2">
                        ...
                        <p style="padding-left: 15px;">Call Us: 
                                         (876) 457-2545</p>
